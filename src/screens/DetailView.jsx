...
const styles = StyleSheet.create({
  ...
  heroLang: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12 },
  ...
  posterModalHint: { color: 'rgba(255,255,255,0.4)', fontFamily: T.fontFun, fontSize: 12, marginTop: 16 },
  ...
  droppedBannerSub: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12 },
  ...
  planNote: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12 },
  planRatingNudge: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 13, fontStyle: 'italic', lineHeight: 20 },
  ...
  globalSource: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12, textAlign: 'right' },
  globalRating: { color: T.textPrimary, fontFamily: T.fontMono, fontSize: 14, fontWeight: '600' },
  reaction: { color: T.textPrimary, fontFamily: T.fontFun, fontSize: 13, lineHeight: 20, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.05)', paddingTop: 14, fontStyle: 'italic' },
  ...
  logWidgetSub: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 13 },
  ...
  logModeText: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 11 },
  ...
  stepperLabel: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 13 },
  ...
  markAllText: { color: T.amber, fontFamily: T.fontFun, fontSize: 13 },
  ...
  epNotes: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12, marginTop: 2 },
  noteBtn: { padding: 8 },
  noteBtnText: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12, opacity: 0.7 },
  ...
  noteCancelText: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12, padding: 4 },
  ...
  planCalloutSub: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 11, marginTop: 2 },
  timeline: { gap: 0 },
