...
const styles = StyleSheet.create({
  ...
  sheet: { backgroundColor: T.surface, borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '88%', marginHorizontal: 2, paddingBottom: 10 },
  ...
  rewatchSub: { color: T.textMuted, fontFamily: T.fontFun, fontSize: 12, lineHeight: 18 },
