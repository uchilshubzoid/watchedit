...
const styles = StyleSheet.create({
  ...
  headerSub: { color: T.textMuted, fontFamily: T.fontBody, fontSize: 13 },
  closeBtn: { padding: 4 },
  ...
  fieldHint: { color: T.amberSoft, fontFamily: T.fontBody, fontSize: 12 },
  ...
  modeBtnText: { color: T.textMuted, fontFamily: T.fontBodyMedium, fontSize: 13 },
  ...
  completeSub: { color: T.textMuted, fontFamily: T.fontBody, fontSize: 12 },
