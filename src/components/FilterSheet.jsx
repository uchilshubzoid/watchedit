...
const styles = StyleSheet.create({
  ...
  activePillText: { color: T.textMuted, fontFamily: T.fontBody, fontSize: 11, lineHeight: 14 },
  ...
  navLabel: { color: T.textMuted, fontFamily: T.fontBodyMedium, fontSize: 14, lineHeight: 17, flex: 1 },
  ...
  dateCalloutText: { color: T.textMuted, fontFamily: T.fontBody, fontSize: 11, flex: 1 },
  dateTrigger: {
